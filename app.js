let phrases = [
    { text: 'отправить маме смешную гифку', image: 'https://code.s3.yandex.net/web-code/procrastinate/1.gif' },
    ...
    { text: 'посмотреть Познера', image: 'https://code.s3.yandex.net/web-code/procrastinate/4.png' },
    { text: 'немного убраться дома', image: 'https://code.s3.yandex.net/web-code/procrastinate/5.png' },
